                      ...
                      if(snapshot.connectionState == ConnectionState.done){
                        if(snapshot.hasError){
                          ...
                          while(idx < snapshot.data[0]['total-policy-amount']){
                            if(globalNewNames == snapshot.data[0]['$idx']['policy-holder-name']){
                              if(globalPolicyVehicleIndexes[globalCurrentPolicyIndex] == snapshot.data[0]['$idx']['vehicle-index']){
                                if(globalCurrentPolicyIndex == snapshot.data[0]['$idx']['policy-number']){
                                  currentIdx = idx;
                                }
                              }
                            }
                          ...
                          */
                          ...
                          if(snapshot.data[0]['$globalCurrentPolicyIndex']['status-waiting-user-schedule-approval']){
                            return  Positioned(
                              top: 50,
                              left: 850,
                              child: Container(
                                        ...
                                        Container(
                                          ...
                                          child: TextButton(
                                            onPressed: () async {
                                              ...
                                              await dataBaseService.requestsDocUpdateUserApprovalToInspection(
