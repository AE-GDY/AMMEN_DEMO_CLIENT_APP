                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(snapshot.data[signInAsBroker?currentBrokerCompany:currentInsuranceCompany]['$globalCurrentClaimIndex']['status-waiting-ic-approval']?
                              "Schedule Link Sent":""
                              ),
                              Container(
                                width: 150,
                                height: 40,
                                decoration: BoxDecoration(
                                  color: snapshot.data[signInAsBroker?currentBrokerCompany:currentInsuranceCompany]['$globalCurrentClaimIndex']['status-waiting-ic-approval']?Colors.white:Colors.blue,
                                  borderRadius: BorderRadius.circular(10),
                                ),
                                child: TextButton(
                                  onPressed: () async {
                ...
                //  padding: const EdgeInsets.all(10),
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 20,),
                      Text("Overall Fees: $overallFees", style: TextStyle(
                        fontSize: 20,
                      ),),
                    ],
                  ),
