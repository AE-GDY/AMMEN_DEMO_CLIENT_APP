...
import 'package:newest_insurance/pages/add_user.dart';
...
import 'package:newest_insurance/pages/policy_attachments.dart';
...
import 'package:newest_insurance/pages/signup.dart';
import 'package:newest_insurance/pages/user_management.dart';
...
Future main() async {
  ...
  await Firebase.initializeApp(
    options: FirebaseOptions(
      ...
      storageBucket: "insurance-project-7c01e.appspot.com",
    ),
  );
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/attachments':(context) => PolicyAttachments(),
        '/management':(context) => UserManagement(),
