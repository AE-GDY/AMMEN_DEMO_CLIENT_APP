...
class DataBaseService{
  ...
  Future signUpCompany(
    ...
    companyType == "Broker Company"?brokerCompanyList:serviceCenterList).doc(companyType == "Insurance Company"?'insurance-company-list':
    companyType == "Broker Company"?'broker-company-list':'service-center-list').set({
      '$companyIndex' : {
