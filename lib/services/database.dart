...
class DataBaseService{
  ...
  Future addUser(
      int companyIndex,
      int userIndex,
      bool serviceCenterLoggedIn,
      String email,
      String password,
      String role,
      bool sv, se, iv, ie, uv, ue, cv, ce
      ) async {
    return await (!serviceCenterLoggedIn?insuranceCompanyList:
    serviceCenterList).doc(!serviceCenterLoggedIn?'insurance-company-list':'service-center-list').set({
      '$companyIndex' : {
        'users':{
          '$userIndex':{
            'email': email,
            'password': password,
            'role': role,
            'scheduling-visible': sv,
            'scheduling-editable': se,
            'inspection-visible': iv,
            'inspection-editable': ie,
            'underwriting-visible': uv,
            'underwriting-editable': ue,
            'completion-visible': cv,
            'completion-editable': ce,
          },
        },
