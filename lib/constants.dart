...
//Keeps track of which tab is selected when regulator is logged in
String currentRegulatorTab = "Dashboard";
...
List<String> insuranceCompanyListStatic = [
  'Gig Egypt',
  'Misr Insurance',
...
int globalCurrentCompanyIndex = 0;
int globalSignedInUserIndex = 0;
...
List<String> serviceCentersAndWorkshopsListStatic = [
...
String currentInsuranceCompany = "Gig Egypt";
