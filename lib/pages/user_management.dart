...
class _UserManagementState extends State<UserManagement> {
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    height: 50,
                                    decoration: BoxDecoration(
                                      color: admin?mainColor:Colors.grey,
                                    ...
                                    child: TextButton(
                                      ...
                                      child: Text("Admins",style: TextStyle(
                                        color: Colors.white,
                                      ),),
                                    ),
                                  ),
                                  ...
                                  Container(
                                    ...
                                    height: 50,
                                    decoration: BoxDecoration(
                                      color: admin?Colors.grey:mainColor,
                                      borderRadius: BorderRadius.circular(10),
                                    ),
                                    child: TextButton(
                                      onPressed: (){
                              ...
                              Container(
                                ...
                                child: Text(admin?"Admins":"Users",style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 16,
  ...
  Widget buildBody(bool admin,AsyncSnapshot<dynamic> snapshot){
    if(admin){
      return Expanded(
          child: ListView.builder(
              itemCount: snapshot.data['$globalCurrentCompanyIndex']['user-amount'],
              itemBuilder: (context,index){
                if(snapshot.data['$globalCurrentCompanyIndex']['users']['$index']['role'] == 'Admin'){
                  return Card(
                    elevation: 0.5,
                    child: Container(
                      child: TextButton(
