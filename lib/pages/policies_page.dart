...
class _PoliciesPageState extends State<PoliciesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    print("ins comp: $currentInsuranceCompany");
                    ...
                    if (snapshot.connectionState == ConnectionState.done) {
                      if (snapshot.hasError) {
                        ...
                        while(idx <= snapshot.data[0]['total-policy-amount']){
                          ...
                          userIndexes.add(snapshot.data[0]['$idx']['policy-holder-index']);
  ...
  Widget buildDataTable(
    ...
    int currentPolicyIndex = 0;
      ...
      if(policyApprovedByIC[currentPolicyIndex] == false){
        ...
        newMap['user-index'] = userIndexes[currentPolicyIndex];
                      ...
                      onPressed: () async {
                        if(snapshot.data['${current['policy-number']}']['status-waiting-user-schedule-approval'] == false){
                          setState(() {
                            ...
                            globalUserIndex = current['user-index'];
