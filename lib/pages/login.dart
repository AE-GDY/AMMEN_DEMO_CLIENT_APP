                      ...
                      if(isValid){
                        ...
                        setState(() {
                          if(!signInAsBroker && !signInAsRegulator && !signInAsServiceOrWorkshop){
                            ...
                            while(currentIndex <= snapshot.data['company-amount']){
                              int userIndex = 0;
                              while(userIndex < snapshot.data['$currentIndex']['user-amount']){
                                if(snapshot.data['$currentIndex']['users']['$userIndex']['email'] == email){
                                  if(snapshot.data['$currentIndex']['users']['$userIndex']['password'] == password){
                                    currentInsuranceCompany = snapshot.data['$currentIndex']['company-name'];
                                    globalCurrentCompanyIndex = snapshot.data['$currentIndex']['company-index'];
                                    currentRole = snapshot.data['$currentIndex']['users']['$userIndex']['role'];
                                    globalSignedInUserIndex = userIndex;
                            ...
                            while(currentIndex <= snapshot.data['company-amount']){
                              ...
                              while(userIndex < snapshot.data['$currentIndex']['user-amount']){
                                if(snapshot.data['$currentIndex']['users']['$userIndex']['email'] == email){
                                  if(snapshot.data['$currentIndex']['users']['$userIndex']['password'] == password){
                                    currentServiceOrWorkshop = snapshot.data['$currentIndex']['company-name'];
                                    globalCurrentCompanyIndex = snapshot.data['$currentIndex']['company-index'];
                                    currentRole = snapshot.data['$currentIndex']['users']['$userIndex']['role'];
                                    globalSignedInUserIndex = userIndex;
                                    if(currentRole == 'Admin'){
        ...
        builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
          if(snapshot.connectionState == ConnectionState.done){
            if(snapshot.hasError){
              ...
              while(companyIndex <= snapshot.data['company-amount']){
                companies.add(snapshot.data['$companyIndex']['company-name']);
                companyIndex++;
              }
              ...
              return Row(
                ...
                children: <Widget>[
                  Container(
                    height: 1.5 * (MediaQuery.of(context).size.height / 20),
                    width: 5 * (MediaQuery.of(context).size.width / 19),
                    margin: EdgeInsets.only(bottom: 20),
